    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!--
                <p class="phar mb-0 mt-5">2, Choose a Bank for Payment</p>
                <ul>
                    <li><input type="radio" name="bank" id="BDO" value="Banco de Oro" checked> <label for="BDO" class="title">BDO(Banco de Oro)</label></li>
                    <li><input type="radio" name="bank" id="BPI" value="Bank of Philippine Island"> <label for="BPI" class="title">BPI(Bank of Philippine Island)</label></li>
                    <li><input type="radio" name="bank" id="GCash" value="GCash"> <label for="GCash" class="title">GCash</label></li>
                    <li class="option-display">
                        <div id="disp-bdo">
                            <table class="modal-disp-details">
                                <tr>
                                    <td>Account No.:</td>
                                    <td>654-893-542-832</td>
                                </tr>
                                <tr>
                                    <td>Account Name:</td>
                                    <td>PLMAR BDO FINANCE</td>
                                </tr>
                                <tr>
                                    <td><a href="https://www.bdo.com.ph/personal"><i class="fas fa-link"></i> BDO Link</a></td>
                                </tr>
                            </table>
                        </div>
                        <div id="disp-bpi">
                            <table class="modal-disp-details">
                                <tr>
                                    <td>Account No.:</td>
                                    <td>009542-5197-21</td>
                                </tr>
                                <tr>
                                    <td>Account Name:</td>
                                    <td>PLMAR BPI FINANCE</td>
                                </tr>
                                <tr>
                                    <td><a href="https://online.bpi.com.ph/portalserver/onlinebanking/sign-in"><i class="fas fa-link"></i> BPI Link</a></td>
                                </tr>
                            </table>
                        </div>
                        <div id="disp-gcash">
                            <table class="modal-disp-details">
                                ...
                                <tr>
                                    <td>Account Name:</td>
                                    <td>PLMAR GCASH FINANCE</td>
                                </tr>
                                <tr>
                                    <td><a href="https://www.gcash.com/"><i class="fas fa-link"></i> GCash Link</a></td>
                                </tr>
                            </table>
                        </div>
                    </li>
                ...
                <p class="phar mb-0 mt-5">3, Upload your Bank transfer receipt(Sreenshot or any file)</p>
                <ul>
                    <li class="option-display">
                        <div class="d-flex">
                            <button class="plmar-btn" id="btn-file-explorer" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;"><i class="fas fa-file-upload"></i> Upload File</button>
                            <input type="text" class="plmar-input" id="file-output" style="max-width: 230px; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" readonly>
