...
<div class="modal-header">
    <h5 class="modal-title">On Process Payment</h5>
...
<div class="modal-body">
    <div class="name-img">
        ...
        <div class="approval-inputs mt-3">
            <label class="title">Approval Inputs</label>
            <div class="mx-2">
                <label class="title">Amount Paid</label>
                <input type="text" id="amount-paid" class="plmar-input mb-2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">

                <label class="title">Date Paid</label>
                <input type="date" id="date-paid" class="plmar-input">
                <button class="d-block ms-auto mt-3 plmar-btn" id="btn-submit-payment" data-status="approved">Submit Payment</button>
            </div>
        </div>
    </div>
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-danger" id="btn-reject-payment" data-status="rejected">Reject Payment</button>
</div>